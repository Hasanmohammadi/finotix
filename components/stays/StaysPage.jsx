        ...
        <div className="stays-page-style">
          <div className="block text-center mobile-view">
            <h1 className="f-51 font-medium">
              {' '}
              <span className="font-black"> {t('staysText.hotels')} </span>{' '}
              <span className="font-black">{t('staysText.homes')} </span>{' '}
              <span className="font-thin">{t('staysText.text')} </span>
            </h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6">
                  <div className="flex border custom-border md:col-span-3 w-full">
                    ...
                    <div className="self-center">
                      <label
                        className="block text-justify w-96"
                        htmlFor="ticket-from"
                      >
                        {t('go')}
                      </label>
                      <input
                        className="block placeholder-from-to"
                        type="text"
                        id="ticket-from"
                        onKeyDown={handleKeyDown}
                        placeholder={t('goHitPoint')}
                      />
                    </div>
                  </div>
                  <div className="flex border custom-border md:col-span-2 w-full">
                    <div className="date-picker w-full">
                      ...
                      <div className="grid text-justify self-center px-4">
                        <label className="self-center" htmlFor="date-picker">
                          {t('date')}
                        </label>
                        <input
